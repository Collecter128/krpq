...
public class Kuuga_Rider_Items_PixelQuest {
    ...
    public static final DeferredItem<Item> KUUGA_RISING_GROWING = ITEMS.register("kuuga_rising_growing",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),0,"_rising_growing","kuuga","arcle_belt_r",
    ...
    public static final DeferredItem<Item> KUUGA_SUPER_RISING_GROWING = ITEMS.register("kuuga_super_rising_growing",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),0,"_super_rising_growing","kuuga","arcle_belt_r",
    ...
    static final DeferredItem<Item> KUUGA_SUPER_RISING_MIGHTY = ITEMS.register("kuuga_super_rising_mighty",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),0,"_super_rising_mighty","kuuga","arcle_belt_r",
    ...
    public static final DeferredItem<Item> KUUGA_SUPER_RISING_DRAGON = ITEMS.register("kuuga_super_rising_dragon",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),0,"_super_rising_dragon","kuuga","arcle_belt_r",
    ...
    public static final DeferredItem<Item> KUUGA_SUPER_RISING_PEGASUS = ITEMS.register("kuuga_super_rising_pegasus",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),0,"_super_rising_pegasus","kuuga","arcle_belt_r",
    ...
    public static final DeferredItem<Item> KUUGA_SUPER_RISING_TITAN = ITEMS.register("kuuga_super_rising_titan",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),0,"_super_rising_titan","kuuga","arcle_belt_r",
    ...
    public static final DeferredItem<Item> KUUGA_AMAZING_GROWING = ITEMS.register("kuuga_amazing_growing",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),0,"_amazing_growing","kuuga","arcle_belt_r",
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 2,true,false))
                    .has_basic_model()
                    .AddToList(RiderTabs.KUUGA_TAB_ITEM));
    ...
    public static final DeferredItem<Item> KUUGA_AMAZING_DRAGON = ITEMS.register("kuuga_amazing_dragon",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),0,"_amazing_dragon","kuuga","arcle_belt_r",
    ...
    public static final DeferredItem<Item> KUUGA_AMAZING_PEGASUS = ITEMS.register("kuuga_amazing_pegasus",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),0,"_amazing_pegasus","kuuga","arcle_belt_r",
                    new MobEffectInstance(MobEffects.NIGHT_VISION, 400, 0,true,false),
                    new MobEffectInstance(Effect_core.RADAR, 40, 0,true,false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 3,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 2,true,false))
    ...
    public static final DeferredItem<Item> KUUGA_AMAZING_TITAN = ITEMS.register("kuuga_amazing_titan",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),0,"_amazing_titan","kuuga","arcle_belt_r",
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3,true,false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 0,true,false),
    ...
    public static final DeferredItem<Item> KUUGA_AMAZING_ULTIMATE = ITEMS.register("kuuga_amazing_ultimate",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.RARE),0,"_amazing_ultimate","kuuga","arcle_belt_ru",
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3,true,false),
